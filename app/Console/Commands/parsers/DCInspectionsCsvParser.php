...
class DCInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-dc-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/washington-dc/DoCInspections.csv';
    ...
    public function handle()
    {
        ...
        while (($data = fgetcsv($handle, 2000, ";")) !== false) {
            ...
            if (!$facility) {
                ...
                $reportDate = date('Y-m-d', strtotime(str_replace('-', '/', $data[2])));
                ...
                $inspection->report_url = $data[0] . ".pdf";
