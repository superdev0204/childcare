...
class WyomingInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-wyoming-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/wyoming/WyomingInspections.csv';
