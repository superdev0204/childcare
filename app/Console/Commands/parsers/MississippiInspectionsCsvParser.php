...
class MississippiInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-mississippi-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/mississippi/MsdhInspections.csv';
