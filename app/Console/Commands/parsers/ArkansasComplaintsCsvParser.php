...
class ArkansasComplaintsCsvParser extends Command
{
    protected $signature = 'custom:parse-arkansas-complaints-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/arkansas/ArkansasComplaints.csv';
        ...
        while (($data = fgetcsv($handle, 3000, ";")) !== FALSE) {
            ...
            if (!$facility) {
                ...
                $inspection = Inspections::where('facility_id', $facility->id)
                                        ->where('report_type', 'Facility Complaint')
                ...
                if (!$inspection) {
                    ...
                    $inspection->report_type = 'Facility Complaint';
                ...
                $inspection->rule_description = $data[2] . " - " . $data[3];
                $inspection->state = 'AR';
