...
class NewMexicoInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-new-mexico-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/new-mexico/NewMexicoInspections.csv';
    ...
    public function handle()
    {
        ...
        while (($data = fgetcsv($handle, 2000, ";")) !== false) {
            ...
            if (!$facility) {
                ...
                $inspection->report_status = $data[7];
