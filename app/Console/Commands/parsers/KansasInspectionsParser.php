...
class KansasInspectionsParser extends Command
{
    protected $signature = 'custom:parse-kansas-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/kansas/KansasLicensing.csv';
