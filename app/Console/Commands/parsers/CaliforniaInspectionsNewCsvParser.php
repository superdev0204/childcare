...
class CaliforniaInspectionsNewCsvParser extends Command
{
    protected $signature = 'custom:parse-california-inspections-new-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/california/CaliforniaInspections.csv';
