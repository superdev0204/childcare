...
class VirginiaInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-virginia-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/virginia/VirginiaCCInspections.csv';
        ...
        while (($data = fgetcsv($handle, 1000, ";")) !== false) {
            ...
            if (!$facility) {
                ...
                $inspection = Inspections::where('facility_id', $facility->id)
                                        ...
                                        ->where('report_status', $data[3])
                                        ->where('current_status', $data[4])
                                        ->first();
                ...
                $inspection->report_url = "http://www.dss.virginia.gov" . $data[5];
