...
class DCComplaintsCsvParser extends Command
{
    protected $signature = 'custom:parse-dc-complaints-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/washington-dc/DoCComplaints.csv';
    ...
    public function handle()
    {
        ...
        while (($data = fgetcsv($handle, 2000, ";")) !== false) {
            ...
            if (!$facility) {
                ...
                $inspection->status_date = date('Y-m-d', strtotime(str_replace('-', '/', $data[4])));
