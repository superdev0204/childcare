...
class WashingtonInspectionsParser extends Command
{
    protected $signature = 'custom:parse-washington-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/washington-state/WashingtonInspections.csv';
