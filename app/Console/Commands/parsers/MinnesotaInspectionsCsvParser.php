...
class MinnesotaInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-minnesota-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/minnesota/MinnesotaInspections.csv';
