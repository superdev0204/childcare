...
class ColoradoComplaintsCsvParser extends Command
{
    protected $signature = 'custom:parse-colorado-complaints-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/colorado/ColoradoComplaints.csv';
    ...
    public function handle()
    {
        ...
        while (($data = fgetcsv($handle, 2000, ";")) !== false) {
            ...
            if (!$facility) {
                ...
                $inspection->report_type = 'Complaint';
                $inspection->state = 'CO';
