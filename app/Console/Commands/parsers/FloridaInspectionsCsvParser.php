...
class FloridaInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-florida-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/florida/FloridaCCInspections.csv';
