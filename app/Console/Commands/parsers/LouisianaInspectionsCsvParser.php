...
class LouisianaInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-louisiana-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/louisiana/LouisianaInspections.csv';
