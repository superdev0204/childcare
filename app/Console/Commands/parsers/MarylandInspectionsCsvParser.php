...
class MarylandInspectionsCsvParser extends Command
{
    protected $signature = 'custom:parse-maryland-inspections-csv';
    protected $description = 'Parse data using a specified parser';
    protected $file = '/datafiles/maryland/MarylandInspections.csv';
